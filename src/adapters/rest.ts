...
app.get('/compromissos', async (req: Request, res: Response) => {
    try {
...
app.post('/compromissos', async (req: Request, res: Response) => {
    const { data, hora_inicio, hora_fim, descricao } = req.body as {
        data: string; hora_inicio: string; hora_fim: string; descricao: string;
    };
